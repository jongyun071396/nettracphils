...
@section('body')
	<div class="container" style="padding:30px">
		<div class="row">
			<div class="col-xs-12">
				<h2>NetTrac Communications Inc. - Subscriber Service Agreement.</h2>
				<h4>TERMS AND CONDITIONS OF SERVICE </h4>													
				<h5>For the purpose of this agreement:</h5>
				<div class="col-xs-12">
					<div class="col-xs-6">
						<b>"Affiliate"</b> means a corporation controlled by or under common control with NETTRAC. <br>
						<b>"Customer"</b> means a Person who has:
						requested or been furnished with the Service or other communications services from or by NETTRAC, an Affiliate or
						obtained installation, of any other form of service or equipment from NetTrac, an affiliate or their respective employees, agents, dealers subcontractors or suppliers, and includes a User who has signed the receding page of this form. <br>
					</div>
					<div class="col-xs-6">
						<b>"Person"</b> includes a partnership, firm, body corporate or politic, government or department or agency thereof and the legal representatives of such person. <br>
						<b>"Service"</b>means data transmission and communication service furnished by NETTRAC. <br>
						<b>"User"</b> means a Person who uses the service or other communications services furnished by NetTrac or their respective employees, agents, dealers, subcontractors or suppliers whether or not that Person is a Customer. 
					</div>	
				</div>
				<div class="col-xs-12">
					<h3>Subsciption</h3>
					<ol>
						<li value="1">
							Upon acceptance of this agreement by NetTrac, this agreement shall constitute a subscription by the Customer for the service.
						</li>
						<li>
							The Customer warrants and agrees that it is and will be the end user of the Service.
						</li>
					</ol>
					<h4>RULES AND REGULATIONS</h4>
					<ol>
						<li value="3">
							The Customer agrees to abide by all the rules and regulations governing the use of Service that may be issued or adopted by NetTrac Communications Inc. from time to time and furnish to the Customer either verbally or in writing, relating to the provision of the Service. This is understood to mean all coding best practices, network congestion and nuisance issues, spamming or otherwise affecting the ability of any customer use the provided service or where any security risk is introduced to the service either inadvertently or intentionally
							The Customer agrees that they shall be solely responsible for the content of their website and subdirectories and shall abide by all laws and regulations as stipulated in the Province of Ontario Canada and the CRTC.
						</li>
					</ol>
					<h4>RATES AND CHARGES</h4>
					<ol>
						<li value="4">
							<ol type="A">
								<li>
								...
								<li>
									The customer agrees to pay NetTrac for any message toll charges or other network service charges incurred by the customer in using the service to make long distance calls or to access the services of other communications or telecommunications carriers, bulletin board services or other information providers who charge a tariff for their products and or services.
								</li>
								<li>
					...
					<h4>CHANGES IN RATES AND OTHER TERMS</h4>
					<ol>
						<li value="5">
						...
						<li value="6">
							<ol type="A">
								...
								<li>
									...
									<ol type="I">
										<li>
											IN THE CASE OF SUCH AN INTERRUPTION TO OR FAILURE OF TRANSMISSION SERVICE LASTING 24 HOURS OR MORE FROM THE TIME NETTRAC IS ADVISED OF THEINTERRUPTION OR FAILURE, MAKE A REFUND OF THE CHARGED PROPORTIONATE TO THE LENGTH OF THE INTERRUPTION OR FAILURE OF SERVICE; AND									</li>
										</li>
										<li>
											IN THE CASE OF INTERRUPTION TO OR FAILURE OF MESSAGE SERVICE, MAKE A REFUND OF CHARGES, COMPUTED FROM THE TIME THAT NETTRAC IS ADVISED OF THE INTERRUPTION OR FAILURE;									</li>
										</li>
									</ol>	
					...
					<h4>RENEWAL AND TERMINATION OF PRICE PLANS OTHER THAN TERM PLANS</h4>
					<ol>
						<li value="8">
					...
					<h4>TERMINATION OF TERM PLAN</h4>
					<ol>
						<li value="9">
							<ol type="A">
								<li>
