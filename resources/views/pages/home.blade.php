...
<div class="container" id="home_content">
    <div class="row justify-content-md-center" id="types" style="margin-left:70px;">
        <div class="col-md-3 services">
            ...
            <br/>
            <span class="label-important"> FREE</span>
            <p class="definition">
            ...
            <br/>
            <span class="label-important"> Php 10,000</span>
            <p class="definition">
            ...
            <br/>
            <span class="label-important"> Php 15,000</span>
            <p class="definition">
            ...
            <br/>
            <span class="label-important"> Php 30,000</span>
            <p class="definition">
        ...
        <div class="col-md-3 col-md-offset-1 services">
            ...
            <br/>
            <span class="label-important"> Php 149/month</span>
            <p class="definition">
            ...
            <br/>
            <span class="label-important"> Php 229/month</span>
            <p class="definition">
            ...
            <br/>
            <span class="label-important"> Php 299/month</span>
            <p class="definition">
        ...
        <div class="col-md-3 col-md-offset-1 services">
            ...
            <br/>
            <span class="label-important"> Php 400/month</span>
            <p class="definition">
            ...
            <br/>
            <span class="label-important"> Php 800/month</span>
            <p class="definition">
            ...
            <br/>
            <span class="label-important"> Php 1,000/month</span>
            <p class="definition">
            ...
            <br/>
            <span class="label-important"> Php 2,400/month</span>
            <p class="definition">
